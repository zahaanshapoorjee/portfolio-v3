...
const Navbar = ({ handleNavigation, mySceneRef }) => {
  ...
  return (
    <div style={navbarStyle}>
      <button style={buttonStyles} onMouseLeave={handleLeave} onMouseEnter={() => handleButtonClick(new THREE.Vector3(4, 0, 0))}>About Me</button>
      <button style={buttonStyles} onMouseLeave={handleLeave} onMouseEnter={() => handleButtonClick(new THREE.Vector3(-4, 0, 0))}>Football</button>
      <button style={buttonStyles} onMouseLeave={handleLeave} onMouseEnter={() => handleButtonClick(new THREE.Vector3(0, 0, 4))}>Skills</button>
      <button style={buttonStyles} onMouseLeave={handleLeave} onMouseEnter={() => handleButtonClick(new THREE.Vector3(0, 0, -4))}>Projects</button>
    </div>
  );
};
